        ...
        <div className="relative w-full min-h-[720px]">
          ...
          <div className="py-4">
            <p className="text-muted-foreground">
              ...
              <p className="text-muted-foreground">The dashboard collectively explores how demographic and socioeconomic factors such as age and income, relate to patterns of firearm ownership and mortality across U.S. states from 2014 to 2017.</p>
          </div>
        </div>
